...
URL:    http://bugzilla.gnome.org/enter_bug.cgi?product=vte
...
# https://bugzilla.redhat.com/show_bug.cgi?id=599344
# fix is upstream
Patch0: vte-strict-aliasing.patch

# https://bugzilla.redhat.com/show_bug.cgi?id=602452
# fix is upstream
Patch1: vte-fullscreen-redraw.patch

# https://bugzilla.redhat.com/show_bug.cgi?id=613110
# fix is upstream
Patch2: vte-CVE-2010-2713.patch
...
export PYTHON
%configure --enable-shared --disable-static --libexecdir=%{_libdir}/%{name} --without-glX --disable-gtk-doc
make %{?_smp_mflags}
...
%changelog
* Mon Jul 19 2010 Tomas Bzatek <tbzatek@redhat.com> 0.25.1-5
- Fix for the CVE-2010-2713 security issue (#615045)

* Tue Jun 29 2010 Matthias Clasen <mclasen@redhat.com> 0.25.1-4
- Package review cleanups
Resolves: #609101

* Mon Jun 14 2010 Matthias Clasen <mclasen@redhat.com> 0.25.1-3
- Fix a fullscreen redraw issue
Resolves: #602452

* Mon Jun  7 2010 Matthias Clasen <mclasen@redhat.com> 0.25.1-2
- Fix a strict aliasing issue
Resolves: #599344

* Wed May 19 2010 Behdad Esfahbod <behdad@redhat.com> 0.25.1-1
- Update to 0.25.1-1
- Resolves: #469930
